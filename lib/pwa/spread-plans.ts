...
export const SPREAD_PLANS: Record<string, SpreadPlan> = {
  "spread-three-card": {
...
export const AUTO_DRAW_SPREAD_IDS = Object.keys(SPREAD_PLANS);

export function getSpreadPlan(spreadId: string): SpreadPlan | undefined {
  return SPREAD_PLANS[spreadId];
}
...
export function chooseSpreadPlanByKeyword(question: string): SpreadPlan {
